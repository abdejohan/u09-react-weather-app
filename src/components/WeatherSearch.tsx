...
const WeatherSearch = (props: any, e:any) => {
  ...
  function getLocation() {
    const quickWeatherContainer = document.getElementsByClassName('weather-search__inner-geo-container')[0] as HTMLElement;
  

    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(getPosition);
    }
    async function getPosition(position: { coords: { latitude: any; longitude: any; }; }) {
      ...
      try {
        ...
        return (
          ...
          setTimeout(function(){ 
            ...
            quickWeatherContainer.innerHTML = data.name.toString() + ": " +
      ...
      <form onSubmit={props.api_call} className="weather-search__form">
        ...
        <div className="weather-search__bottom-info-bar">
          ...
          <div className="weather-search__geo-container">
            <div className="weather-search__inner-geo-container" onClick={getLocation}>
              <span className="weather-search__geo-location">QUICK WEATHER</span>
